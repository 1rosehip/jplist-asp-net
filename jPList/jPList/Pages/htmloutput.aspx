<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="htmloutput.aspx.cs" Inherits="jPList.htmloutput" MasterPageFile="~/Site.master" %>
        		...
        		$('#demo').jplist({
				    ...
				    , dataSource: {
					    ...
					    , server: {
					        ...
					        //ajax settings
					        ajax: {
					            url: '/web/HTMLOutputHandler.ashx'
							    , dataType: 'html'
							    , type: 'POST'
					        }
					    }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyPlaceHolder">
	...
	<div class="center">
		...
		<div class="box text-shadow">
			<h1 class="h1-30-normal left">ASP.NET and SQL Server Demo - HTML Output</h1>
		</div>
