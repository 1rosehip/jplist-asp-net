/*
 jPList - jQuery Data Grid Controls 5.1.124 - http://jplist.com 
...
[!0])):a.observer.trigger(a.observer.events.forceRenderStatusesEvent,[!0]);return jQuery.extend(this,a)};jQuery.fn.jplist=function(b){return this.each(function(){var e=new c(b,jQuery(this));jQuery(this).data("jplist",e)})};jQuery.fn.jplist.controlTypes={};jQuery.fn.jplist.itemControlTypes={};jQuery.fn.jplist.app=jQuery.fn.jplist.app||{};jQuery.fn.jplist.app.services=jQuery.fn.jplist.app.services||{};jQuery.fn.jplist.app.services.DTOMapperService=jQuery.fn.jplist.app.services.DTOMapperService||{};
